...
export function localSquidReply(messages, session) {
  ...
  const walletLine = connected
    ...
    : "No wallet is connected yet. Connect on the entry screen with MetaMask, Coinbase, Phantom, or Backpack.";
  ...
  return [
    connected
      ...
      : "Connect a wallet on the entry screen to give me a session to talk about.",
